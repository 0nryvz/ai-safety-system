...
class ViolationRulePropertiesTest {
    ...
    @Test
    void usesDefaultMinimumMissingEquipmentForUnprotectedPerson() {
        ViolationRuleProperties properties =
                new ViolationRuleProperties();

        assertThat(
                properties.getMinimumMissingEquipmentForUnprotectedPerson()
        ).isEqualTo(
                2
        );
    }
    ...
    void allowsContainmentThresholdOverride() {
        ...
        properties.setContainmentThreshold(
                0.75
        );
    ...
    @Test
    void allowsMinimumMissingEquipmentOverride() {
        ViolationRuleProperties properties =
                new ViolationRuleProperties();
    ...
    void allowsConfidenceThresholdOverride() {
        ...
        properties.setConfidenceThresholds(
                Map.of(
                        ViolationType.MISSING_GLOVES,
                        0.80
                )
    ...
    @Test
    void rejectsMinimumMissingEquipmentBelowOne() {
        ViolationRuleProperties properties =
                new ViolationRuleProperties();
    ...
    void throwsWhenConfidenceThresholdIsMissing() {
        ...
        assertThatThrownBy(
                ...
                .hasMessageContaining(
                        "No confidence threshold configured"
                );
    }
}