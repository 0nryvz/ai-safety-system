...
class MissingWeldingApronRuleTest {
    ...
    private final MissingWeldingApronRule rule =
            new MissingWeldingApronRule();

    @Test
    void supportsMissingWeldingApronViolationType() {
        assertThat(rule.supportedType())
                .isEqualTo(ViolationType.MISSING_WELDING_APRON);
    }

    @Test
    void producesCandidateWhenWeldingPersonHasNoApron() {
    ...
    @Test
    void doesNotProduceCandidateWhenWeldingPersonHasApron() {
        PersonContext person = new PersonContext(
                "track-worker-1",
                person(),
                List.of(
    ...
    @Test
    void doesNotProduceCandidateWhenPersonIsNotAssociatedWithWelding() {
        PersonContext person = new PersonContext(
                "track-worker-1",
                person(),
                List.of()
